...
public class ObjectFactory {
    ...
    private final static QName _Categorie_QNAME = new QName("http://ws.saison.ws.citron.al33.afcepf.fr/", "categorie");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Categorie }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.saison.ws.citron.al33.afcepf.fr/", name = "categorie")
    public JAXBElement<Categorie> createCategorie(Categorie value) {
        return new JAXBElement<Categorie>(_Categorie_QNAME, Categorie.class, null, value);
    }
